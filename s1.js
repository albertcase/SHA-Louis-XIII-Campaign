...
(lib.a8 = function() {
	this.initialize(img.a8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,364,121);
...
(lib.Symbol11copy = function() {
	...
	mask._off = true;
	mask.graphics.p("A8AJcIAAq6MA4FAAAIAAK6g");
	mask.setTransform(179.8,60.5);
...
p.nominalBounds = new cjs.Rectangle(0.5,51,359.1,70.1);
...
(lib.Symbol11 = function() {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AucEYIAAovIc5AAIAAIvg");
	mask.setTransform(180,24);
...
p.nominalBounds = new cjs.Rectangle(87.5,0,185.1,52);
...
(lib.Symbol5 = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#000000","rgba(0,0,0,0)"],[0.78,1],0,0,0,0,0,296).s().p("EggZAgaQtctcAAy+QAAy+NctcQNctaS9gBQS/ABNcNaQNaNcAAS+QAAS+taNcQtcNcy/gBQy9ABtctcg");
...
(lib.Symbol3 = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#654A12","#CC7B00","#BB8A21","#A3754E","#D8B08E","#B87326","#654A12"],[0,0.188,0.341,0.514,0.686,0.855,1],-113.8,0,113.8,0).s().p("AxxC8IAAl3MAjjAAAIAAF3g");
	this.shape.setTransform(113.8,18.8);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,227.6,37.6);
...
(lib.dot = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgLALQgEgEAAgHQAAgGAEgFQAFgEAGAAQAHAAAEAEQAFAFAAAGQAAAHgFAEQgEAFgHAAQgGAAgFgFg");
...
(lib.btn18 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_1 = new cjs.Graphics().p("AhfBXIAAitIC/AAIAACtg");
	var mask_graphics_2 = new cjs.Graphics().p("AhfBXIAAitIC/AAIAACtg");
	var mask_graphics_3 = new cjs.Graphics().p("AhfBXIAAitIC/AAIAACtg");
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhPAPIAPgNIAoAnQAqhKAtgfIARAOQhBA0gmA/QgagegegUg");
	...
	this.shape_2.graphics.f("rgba(255,255,255,0.098)").s().p("AhFBFIAAiJICKAAIAACJg");
	...
	this.shape_3.graphics.f("rgba(0,0,0,0.008)").s().p("A6YDXIAAmtMA0xAAAIAAGtg");
...
(lib.arrow = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ah2hAIA5AAIA+BDIBAhDIAzAAIADADIh2B+g");
...
(lib.mcTxt = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(102.9,11.6);

	// Layer 10
	this.instance = new lib.Symbol3("synched",0);
	this.instance.setTransform(-124.2,10.9,1,1,0,0,0,113.8,18.8);

	this.instance.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:103.4,y:10.6},79).wait(1));

	// Layer 9
	this.instance_1 = new lib.Symbol3("synched",0);
	this.instance_1.setTransform(103.4,10.9,1,1,0,0,0,113.8,18.8);

	this.instance_1.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:331,y:10.6},79).wait(1));

	// Layer 1 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("");
	mask_1.setTransform(102.6,46);

	// Layer 11
	this.instance_2 = new lib.Symbol3("synched",0);
	this.instance_2.setTransform(-93.8,46.9,0.866,0.745,180,0,0,113.8,18.8);

	this.instance_2.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:103.6,y:46.3},79).wait(1));

	// Layer 7
	this.instance_3 = new lib.Symbol3("synched",0);
	this.instance_3.setTransform(103.4,46.9,0.866,0.745,180,0,0,113.8,18.8);

	this.instance_3.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:300.8,y:46.3},79).wait(1));
...
(lib.mcNext = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(88.4,126.6,1,1,0,0,0,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({startPosition:0},0).to({alpha:0},2).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).wait(1));

	// dot
	this.instance_1 = new lib.dot("synched",0);
	this.instance_1.setTransform(88.4,119.1,1,1,0,0,0,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({startPosition:0},0).to({alpha:0},2).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).wait(2));

	// dot
	this.instance_2 = new lib.dot("synched",0);
	this.instance_2.setTransform(88.4,111.6,1,1,0,0,0,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({startPosition:0},0).to({alpha:0},2).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).wait(3));

	// dot
	this.instance_3 = new lib.dot("synched",0);
	this.instance_3.setTransform(88.4,104.1,1,1,0,0,0,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(12).to({startPosition:0},0).to({alpha:0},2).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).wait(4));

	// dot
	this.instance_4 = new lib.dot("synched",0);
	this.instance_4.setTransform(88.4,96.6,1,1,0,0,0,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({startPosition:0},0).to({alpha:0},2).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).wait(5));

	// dot
	this.instance_5 = new lib.dot("synched",0);
	this.instance_5.setTransform(88.4,89.1,1,1,0,0,0,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(10).to({startPosition:0},0).to({alpha:0},2).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).wait(6));

	// dot
	this.instance_6 = new lib.dot("synched",0);
	this.instance_6.setTransform(88.4,81.6,1,1,0,0,0,1.7,1.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({startPosition:0},0).to({alpha:0},2).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).wait(7));

	// Layer 2
	this.instance_7 = new lib.arrow("synched",0);
	this.instance_7.setTransform(88.3,133,0.581,0.581,0,0,0,11.8,8.8);
...
p.nominalBounds = new cjs.Rectangle(0,0,178,135.5);
...
(lib.mcCir = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_53 = new cjs.Graphics().p("EAUwA/gIAAqIIGHAAIAAKIg");
...
(lib.intro = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("EATzAy2QgIhEgmhLQhKiViPggQtAi6pfphQtYtYAAy8QAAjZAcjQQB/urK9q+QJopqMjisIABAAQCngcBMiZQAnhNAFhGIAUmwIAAGxIAAAAQgFBLgpBQQhRChiwAfQseCqpkJlQqyKziCObQgeDWAADhQAAS0NSNSQJbJdM7C4QCXAiBPCeQAnBOAJBIIAAABIgUEpg");
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("A9mY/QsRsRAAxUQAAiFAskEIAHggQgfDOAADbQAARMMLMLQMLMLRNAAQROAAMLsLQMLsLAAxMQAAxPsLsLQhvhwh2hfQCTBhBgBgQMRMRAARXQAARUsRMRQipCpi4CEQhEAyhHAsQptGGsOAAQxVAAsRsRg");
	...
	mask_2._off = true;
	var mask_2_graphics_0 = new cjs.Graphics().p("AT9dIQAAy0tTtRQoyozrpjEQg4gOg4gNQidgjhZieQgbgxgSg3IAAgBIgLgsIgBgDIAUteIAANdIAMArIgBAAQARA1AaAvQBVCWCUAiQBCAOBAARQLkDIIvIwQNZNXAAS8QAACLgkC0QAQicAAijg");
...
(lib.main = function(mode,startPosition,loop) {
	...
	// blackMaskCor
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],1,-57.8,1,84.1).s().p("Egx/AM3IAA5uMBj+AAAIAAZug");
	this.shape.setTransform(320,82.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-0.9,72.7,-0.9,-105.4).s().p("Egx/AQKMAAAggSMBj+AAAMAAAAgSg");
	...
	this.mcCir.setTransform(320,520,1,1,0,0,0,320,520);
	this.mcCir.alpha = 0;
